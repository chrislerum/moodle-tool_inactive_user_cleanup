...
function tool_obsolete_user_removal_cron() {
  ...
  // and user has never logged in, and user was created before 2013, delete it
  // This may not catch all cases. If a user was created before 2013 but his
  ...
  foreach ($users as $user) {
    ...
    $created_or_last_modified_before_2013 = $year < 2013;

    if ($is_not_guest && $has_never_logged_in && $created_or_last_modified_before_2013) {
